...
@pizzaz_mcp._mcp_server.list_tools()
...
@pizzaz_mcp._mcp_server.list_resources()
...
@pizzaz_mcp._mcp_server.list_resource_templates()
...
pizzaz_mcp._mcp_server.request_handlers[types.CallToolRequest] = _call_tool_request
pizzaz_mcp._mcp_server.request_handlers[types.ReadResourceRequest] = _handle_read_resource
